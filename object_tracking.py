...
video = cv2.VideoCapture("C:/Users/indra/Downloads/PRO-C120-Student_Boilerplate-main/PRO-C120-Student_Boilerplate-main/bb3.mp4")
...
def goal_track(img, bbox):
    ...
    for i in range(len(xs)-1):
        cv2.circle(img,(xs[i],ys[i]),2,(189,189,189),5)
